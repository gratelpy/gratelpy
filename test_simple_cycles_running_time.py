...
from subgraphs import get_all_valid_subgraphs, get_sensible_subgraphs, get_subgraph_components, get_sensible_subgraphs_paths_in_cycles_using_cycle_graph
...
valid_cycles = get_valid_path_graph_cycles(path_graph)
vc = list(valid_cycles)
cycle_graph = get_sensible_subgraphs_paths_in_cycles_using_cycle_graph(sc)

#sg = get_sensible_subgraphs(sc)
