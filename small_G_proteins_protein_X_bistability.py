...
#alpha, beta, complexes, constants, complexes_reverse, constants_reverse = get_network_from_mechanism('../mechanisms/small_G_protein_mechanism.txt', 11)
alpha, beta, complexes, constants, complexes_reverse, constants_reverse = get_network_from_mechanism('../mechanisms/small_G_protein_protein_X_mechanism.txt', 15)
