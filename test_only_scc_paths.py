...
from fragments import get_valid_fragments, score_fragment, get_sensible_fragments, get_edges_of_sensible_fragments, get_sensible_sc, get_subgraph_components, get_sscc
from subgraphs import get_all_valid_subgraphs, get_sensible_subgraphs
...
sg_sc = get_sensible_subgraphs(sc)
